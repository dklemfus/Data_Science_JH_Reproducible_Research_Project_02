...
approximations. To contrast, the standard values are 'K, M, B' which correspond 
to thousands, millions, and billions of dollars in damages. While performing the
exploratory analysis, there were only 309 of 245031 records that contained values
not attributable to the 'K,M,B' format. These 309 records were omitted from the 
analysis. 

To begin the data exploration/cleaning, first define the required packages and 
load the data: 
